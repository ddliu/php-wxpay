...
use ddliu\wxpay\Data\OrderQuery as OrderQueryData;
use ddliu\wxpay\Data\Reverse as ReverseData;
/**
 * 
 * 刷卡支付实现类
 * 该类实现了一个刷卡支付的流程，流程如下：
...
class MicroPay
{
     ...
     * 
     * 提交刷卡支付，并且确认结果，接口比较慢
     * @param \ddliu\wxpay\Data\MicroPay $microPayInput
     * @throws Exception
     * @return 返回查询接口的结果
     */
    ...
    {
        $queryOrderInput = new OrderQueryData();
